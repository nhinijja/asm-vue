        ...
        <div class="profile-wrapper p-4 border rounded">
          <div class="row align-items-start p-5">
            <div class="col-xl-4 col-lg-5 col-md-6">
              <div
                class="d-flex flex-column align-items-center p-3 border rounded-lg shadow-sm"
              >
                <img
              ...
              <div class="sidebar-categories p-3 mt-3 text-center"></div>
            </div>
